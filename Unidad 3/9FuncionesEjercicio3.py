...
# el ingreso
# Todas las personas deben registrar su rut, nombre y edad. Si existe dar la bienvenida 
# mencionando su nombre.
# los datos deben ser almacenados en un archivo .csv
# Otras opciones a realizar: 
#   listar las personas que han ingresado.
#   Creación de archivo
#   Mostrar estadisticas según rango etario que ha entrado al recinto.
